    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=200, unique=True)),
                ('imagen', models.ImageField(blank=True, null=True, upload_to=src.models.user_directory_path)),
            ],
            options={
                'verbose_name': 'Fondo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='src.categoria')),
                ('subcategoria', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='src.subcategoria')),
            ],
            options={
                'verbose_name': 'Video',
